...
public class UserController {
    ...
    @PostMapping("/login")
    @ResponseBody   // Rest 컨트롤러가 아닌 컨트롤러에서 Rest형식으로 리턴을 하게 하고 싶으면 메서드 위해 해당 어노테이션 붙이기
